...
expect_status POST /api/veo/generate 401 '{"prompt":"smoke","modelOptionId":"minimaxh3_720_4","aspectRatio":"16:9"}'
expect_status POST /api/suno/generate 410 '{"prompt":"smoke"}'
