...
- A right details panel is hidden by default and opens only when requested.
...
- More → Remove from recent hides the Prompt and Result record from Create without deleting successful media from Assets.
