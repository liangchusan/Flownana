  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto bg-white">
        ...
        <div className="sticky top-0 z-20 bg-white px-8 py-3 flex items-center justify-between border-b border-slate-200/60">
          ...
          <div>
            {session ? (
              ...
              <Button
                ...
                className="rounded-xl bg-slate-900 text-white border-0 text-sm px-4 py-1.5 transition-all duration-200 hover:opacity-90 hover:-translate-y-[1px] active:scale-[0.98]"
                size="sm"
              >
                Start Free Now
              </Button>
